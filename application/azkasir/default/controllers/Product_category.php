...
class Product_category extends CI_Controller {
	...
	public function index(){
		...
		$column = array('#', azlang('Category'), azlang('Action'));
		...
		$crud->set_modal_title(azlang('Product Category'));
		...
		$data_header['subtitle'] = azlang('PRODUCT CATEGORY');
	...
	public function save(){
		...
		$this->form_validation->set_rules('name', azlang('Category'), 'required|trim|max_length[20]');
